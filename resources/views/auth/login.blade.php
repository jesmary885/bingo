                    ...
                    <div class="flex flex-col bg-white justify-center   px-4   w-full  ">
                        <a class=" flex justify-center w-full " href="{{ route('welcome') }}">
                            ...
                            <div class="mt-10" >
                                ...
                                <div class="bg-red-50 border-l-8 border-red-700 mb-4">
                                    <div class="flex items-center">
                                        <div class="p-2">
                                            <div class="flex items-center">
                                                <div class="ml-2">
                                                    <svg class="h-8 w-8 text-red-700 mr-2 cursor-pointer"
                                                ...
                                                <p class="px-6 py-4 text-red-700 font-semibold text-md">Credenciales incorrectas</p>
                                            </div>
                                            <div class="px-16 mb-4">
                                                <li class="text-md font-bold text-red-500 text-sm">{{Session::get('mensaje')}}</li>
                            ...
                            <form method="POST" action="{{ route('Login') }}">
                                ...
                                <div class="flex flex-col mb-6">
                                    ...
                                    <div class="relative" x-data="{ show: true }">
                                        ...
                                        id="password" type="password" name="password" class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Contraseña">
                                ...
                                <div class="flex justify-between w-full mt-2 ">
                                    <div class=" flex justify-start " >
                                        <a href="{{ route('password.request') }}" class="font-bold text-blue-500 hover:text-blue-700 text-xs text-center">¿Olvidaste tu contraseña?</a>
                                    </div>

                                    <div class=" flex justify-end " >
                                        <a href="{{ route('Registro') }}" class="font-bold text-blue-500 hover:text-blue-700 text-xs text-center">¿Aún no tienes una cuenta?</a>
