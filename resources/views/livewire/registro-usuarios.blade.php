<div>
    <div class="flex relative md:h-screen font-Arima  ">
        ...
        <div class="relative w-full overflow-hidden md:flex bg-gradient-to-tr from-blue-300 to-purple-200 justify-around items-center hidden">
		        <div class="hidden md:block  "  style="width: 42rem; height: 42rem;">
                        ...
                        <div class="mt-1">
                            ...
                            <div class="flex flex-col mb-6">
                                ...
                                <div class="relative" x-data="{ show: true }">
                                    ...
                                    <input :type="show ? 'password' : 'text'"
                                        id="password_confirmation" type="password"  wire:model="password_confirmation" name="password_confirmation"  class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Contraseña">
                            ...
                            @if($referido == 'si')
                                ...
                                <div class="flex flex-col mb-6">
                                    <label for="password" class="mb-1 text-xs sm:text-sm tracking-wide text-gray-600">Código de referido (opcional):</label>
                                    <div class="relative">
