    ...
    <x-dialog-modal wire:model="open">
        ...
        <x-slot name="title">
            <div class=" flex justify-between ">
                ...
                <p class=" font-Allerta text-xs text-center  " >CARTONES GANADORES Y FICHAS SORTEADAS - SORTEO NRO {{$sorteo}}</p>

                <button type="button" wire:click="close" wire:loading.attr="disabled"  class="py-1.5 px-3 me-2 mb-2 text-sm font-bold text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    X
                </button>
                    ...
                    <div class=" bg-white rounded-md shadow-md overflow-hidden">
                        <div class=" bg-blue-500 rounded-t-md shadow-md overflow-hidden md:max-w-xl ">
                            ...
                            <div class="bg-blue-500 m-1 text-center">
                                ...
                                <p class=" text-white text-xs ">Ganancia: {{round($this->premio($carton->carton->id,$carton->sorteo_id),2)}} $ </p>
                            </div>
