        ...
        <div >
            <section class="bg-blue-100">
                <div class="items-center px-8 mx-auto lg:px-16 md:px-12">
                  <div class="justify-center w-full text-center pt-6 max-auto">
                    <div class="justify-center w-full mx-auto">
                      ...
                      <p class=" mt-6  text-[#10172A]  text-lg font-normal ">
                ...
                <div class="flex justify-center pt-6 pb-20 " >
                    ...
                    <a href="{{ route('auth.redirect') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
            ...
            <div class="container mx-auto px-8 relative items-center">
            ...
            <div class=" card  p-8 m-8 -mt-12 rounded-xl border border-white bg-white shadow-md shadow-black/5 saturate-200 ">

                <div class=" ">

                    <h2 class="text-4xl lg:text-5xl text-blue-900 mb-4 text-center  font-black">¿Cómo Jugar en BING+?</strong></h2>

                    <p class="text-lg text-gray-500 leading-relaxed text-center mb-3 ">You must be able to convey information via phone, email, and in person. You want to make sure your tone is always professional but friendly.</p>
                    ...
                    <div class="hidden md:block w-full md:w-8/12 xl:w-7/12 items-start">
                        ...
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500;" xml:space="preserve">
                            ...
                            <g id="Speech_bubble">
                                <g>
                                    <g>
                                        <path style="fill:#407BFF;" d="M351.658,145.652H322.93c-4.886,0-8.846,3.961-8.846,8.846V179.5c0,4.885,3.961,8.846,8.846,8.846
                                    ...
                                    <g>
                                        <g style="enable-background:new    ;">
                                                ...
                                                <ellipse transform="matrix(0.7071 -0.7071 0.7071 0.7071 -19.2188 287.3842)" style="fill:#407BFF;" cx="337.294" cy="166.891" rx="14.258" ry="14.258"/>
                                        </g>
                                        <g>
            ...
            <div class=" px-20 ">
                <div >
                    <h3 class="text-4xl flex justify-center lg:text-5xl text-blue-900 leading-none mb-4 mt-2 font-black">¿Necesitas una guia más para jugar en BING+?</h3>
                    <p class="text-center  text-gray-500 ">Te mostramos un video instructivo Lorem ipsum, dolor sit amet consectetur  </p>
