<x-guest-layout>
    ...
    <main class=" font-montserrat bg-gray-100 ">
        ...
        <div >
            ...
            <div class=" card  p-8 m-8   -mt-8  rounded-xl border border-white bg-white shadow-md shadow-black/5 saturate-200 ">

                <div>

                    <h2 class="text-4xl lg:text-5xl text-blue-900 mb-4 text-center font-Allerta  font-black">¿Cómo Jugar en BING+?</strong></h2>
                ...
                <div class=" flex justify-center items-center">
                    <div class="">
                        ...
                        <div class=" pt-6  md:flex md:justify-between mx-8 ">
                            <!-- Basic Card -->
                            <div class="w-full p-8 bg-white text-center rounded-3xl pr-16 shadow-xl md:mr-2">
                            ...
                            <!-- Enterprise Card -->
                            <div class="w-full p-8 bg-white text-center rounded-3xl pl-16 shadow-xl md:ml-2">
            ...
            <div class=" card  p-8 m-8  rounded-xl border border-white bg-white shadow-md shadow-black/5 saturate-200 ">
                <div >
                    <h3 class="text-4xl lg:text-5xl text-blue-900 mb-4 text-center font-Allerta  font-black">Tráiler de nuestro proceso de pago y juego</h3>
                  
                    <p class="text-center  text-gray-500 font-Arima  ">Para que te familiarices rápidamente con nuestra página web, te presentamos un corto videotutorial donde verás los 4 pasos para jugar en BING+</p>
