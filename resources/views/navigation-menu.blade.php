<nav x-data="{ open: false }" class="bg-white border border-gray-200 shadow-md font-Arima ">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex  h-16">
            ...
            <div class="mt-4 flex flex-1 justify-end mr-4" >
            ...
            <div class="hidden md:flex md:justify-end mt-4">

               

                <a href="{{ route('billetera.index') }}">

                    <div class="bg-green-100 mt-1 text-green-800 text-xs font-medium mr-4 px-2.5 py-1 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400 flex  ">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div >
                ...
                <div class="bg-blue-100 w-full text-green-800 text-xs font-medium mr-4 px-2.5 py-1 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400 flex  ">
                ...
                <x-responsive-nav-link class="flex " href="{{ route('jugar') }}">
                ...
                <x-responsive-nav-link class="flex" href="{{ route('billetera.afiliados') }}">
