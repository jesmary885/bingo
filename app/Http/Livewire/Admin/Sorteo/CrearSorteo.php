            ...
            if($this->tipo == 'agregar'){
                ...
                if($this->premios == "Un premio"){
                    ...
                    $sorteo_creado = Sorteo::create([
                        ...
                        $this->reset(['fecha_inicio','type_1','porcentaje_ganancia','precio_carton_dolar','tipo_sorteo_global']);
                ...
                elseif($this->premios == "Dos premios"){
                    $sorteo_creado = Sorteo::create([
                        ...
                        $this->reset(['fecha_inicio','type_1','type_2','porcentaje_ganancia','porcentaje_ganancia_2','precio_carton_dolar','tipo_sorteo_global']);
                    ...
                    $sorteo_creado = Sorteo::create([
                        ...
                        $this->reset(['fecha_inicio','type_1','type_2','type_3','porcentaje_ganancia','porcentaje_ganancia_2','porcentaje_ganancia_3','precio_carton_dolar','tipo_sorteo_global']);
                }
